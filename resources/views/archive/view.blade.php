    ...
    <x-wholepagewrapper class="bg-[#f9fafb]">
        ...
        <x-taskcontentwrapper>
            <div class="flex gap-3 items-center">
                <a href="{{ route('tasks.archive.list') }}" class="primary-btn"><i class="fa-solid fa-arrow-left"></i> Back</a>
                <h1 class="text-2xl font-medium">View Archived Task</h1>
            </div>
                ...
                <div class="flex flex-col gap-5">
                    ...
                    <div class="flex">
                        <div class="flex-1 flex flex-col">
                            ...
                            <input type="text" class="px-4 py-2 rounded-lg border border-stone-300" value="{{ $task->atc ?? '—' }}" readonly>
                        </div>
                    </div>
                </div>
            </x-formwrapper>
